<?php
namespace ReneGast\ContextItems\ContextMenu;
 ...
 */
class ContextItemProvider extends PageProvider
{
  /**
  ...
  protected $itemsConfiguration = [
      'showContent' => [
          'type' => 'item',
          'label' => 'Page Content', // you can use "LLL:" syntax here
          'iconIdentifier' => 'apps-toolbar-menu-opendocs',
          'callbackAction' => 'showContent' //name of the function in the JS file
      ]
  ];
...
//        return $this->table === 'pages';
  ...
  protected function getAdditionalAttributes(string $itemName): array
  {
      return [
          ...
          'data-callback-module' => 'TYPO3/CMS/ContextItems/ContextMenuActions',
  ...
  public function addItems(array $items): array
  {
      ...
      if (isset($items['edit'])) {
          //finds a position of the item after which 'showContent' item should be added
   ...
   * @return bool
   */
  protected function canShowContent(): bool
  {
